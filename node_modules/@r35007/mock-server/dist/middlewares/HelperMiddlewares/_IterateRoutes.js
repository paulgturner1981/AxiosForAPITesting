...
const _IterateRoutes = (req, res, next) => {
    ...
    if (!Array.isArray(locals.data)) {
        console.error(chalk_1.default.red('To use ') + chalk_1.default.yellowBright('_IterateRoutes') + chalk_1.default.red(' method the data must be of type Array'));
        return next();
    }
...
exports._IterateRoutes = _IterateRoutes;
